...
void qtest_memread_real(QTestState *s, uint64_t addr, void *data, size_t size)
{
    uint8_t *ptr = data;
    gchar **args;
    size_t i;
...
void qtest_bufread_real(QTestState *s, uint64_t addr, void *data, size_t size)
{
    gchar **args;
    size_t len;
...
{
    qtest_memset_real(s, addr, pattern, size);
}
